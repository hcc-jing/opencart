...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ((string)$this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			// gold_type
			if ($this->user->hasPermission('access', 'catalog/gold_type')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_gold_type'),
					'href'     => $this->url->link('catalog/gold_type', 'user_token=' . $this->session->data['user_token']),
					'children' => array()
				);
			}
            ...
            if ($this->user->hasPermission('access', 'supplier/supplier')) {
                $supplier[] = array(
                    ...
                    'href'     => $this->url->link('supplier/supplier', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'supplier/supplier_approval')) {
                // $supplier[] = array(
                //     'name'     => $this->language->get('text_supplier_approval'),
                //     'href'     => $this->url->link('supplier/supplier_approval', 'user_token=' . $this->session->data['user_token']),
                //     'children' => array()
                // );
            }
